  ...
  return (
    <aside className="flex flex-col self-stretch h-auto flex-grow-0 p-10 bg-white border-l border-solid border-l-gray-300 w-[500px] max-md:w-full max-sm:p-5 max-sm:w-full">
      <div className="flex flex-col gap-6">
        <h2 className="text-xl font-medium text-indigo-950 text-right">
          Item summary
        </h2>

        <div className="flex flex-col gap-6">
          <div
            className="flex flex-col items-center p-6 gap-6 rounded-xl"
            style={{ backgroundColor: "rgba(194, 235, 194, 1)" }}
          >
            <div className="flex flex-col gap-2 items-center">
              <div
                className="px-4 py-1 text-xs font-medium rounded-[45px]"
                style={{
                  backgroundColor: "rgba(149, 214, 149, 0.25)",
                  color: "rgba(45, 130, 45, 1)",
                }}
              >
                Selling price
              </div>
